 ...
 * @version 20.0.0 - Prefecture Specialized with Yahoo! JAPAN Style
 * 
 * === Features ===
 ...
 * - Municipality filter enabled
 * - Related prefectures display
 */
...
// 都道府県メタ情報取得（カスタムフィールドがあれば）
$prefecture_meta = get_term_meta($prefecture_id);
$prefecture_icon = isset($prefecture_meta['prefecture_icon']) ? $prefecture_meta['prefecture_icon'][0] : '';
$prefecture_color = isset($prefecture_meta['prefecture_color']) ? $prefecture_meta['prefecture_color'][0] : '#0078ff';
...
$page_description = $prefecture_description ?: 
    ...
    ($region_display_name ? $region_display_name . '地方の地域特性を活かした制度から国の制度まで幅広くカバー。' : '') .
    '市町村別の検索も可能。専門家による申請サポート完備。';
...
if ($region_display_name) {
    $keywords[] = $region_display_name;
}
...
<!-- 構造化データ: GovernmentService -->
<script type="application/ld+json">
<?php echo wp_json_encode($schema_government, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT); ?>
</script>
...
<main class="grant-archive-yahoo-style grant-prefecture-archive" 
    ...
    <!-- 都道府県ヒーローセクション -->
    <header class="prefecture-hero-section" 
            itemscope 
        ...
        <div class="yahoo-container">
            <div class="hero-content-wrapper">
                ...
                <div class="prefecture-badge" 
                     role="status"
                     <?php if ($prefecture_color): ?>
                     style="background: <?php echo esc_attr($prefecture_color); ?>;"
                     <?php endif; ?>>
                    <?php if ($prefecture_icon): ?>
                        <img src="<?php echo esc_url($prefecture_icon); ?>" 
                             alt="<?php echo esc_attr($prefecture_name); ?>アイコン" 
                ...
                <!-- メインタイトル -->
                <h1 class="prefecture-main-title" itemprop="headline">
                    <span class="prefecture-name-highlight"><?php echo esc_html($prefecture_name); ?></span>
                    <span class="title-text">の助成金・補助金</span>
                    <span class="year-badge"><?php echo $current_year; ?>年度版</span>
                </h1>

                <!-- 都道府県説明文 -->
                <div class="prefecture-lead-section" itemprop="description">
                    <?php if ($prefecture_description): ?>
                    <div class="prefecture-description-rich">
                        <?php echo wpautop(wp_kses_post($prefecture_description)); ?>
                    </div>
                    <?php endif; ?>
                    <p class="prefecture-lead-sub">
                        ...
                        <?php endif; ?>
                        市町村別の検索にも対応し、あなたの地域で利用できる助成金を簡単に見つけられます。
                    </p>
                </div>

                <!-- メタ情報 -->
                <div class="prefecture-meta-info" role="group" aria-label="都道府県統計情報">
                    ...
                    <div class="meta-item">
                        ...
                        <span><?php echo esc_html($region_display_name); ?>地方</span>
                    </div>
                    <?php endif; ?>
                    <div class="meta-item">
                        <svg class="meta-icon" 
                ...
                <div class="feature-cards-grid">
                    ...
                    <article class="feature-card">
                        ...
                        <div class="feature-card-content">
                            <h3>市町村別検索対応</h3>
                            <p>県の制度から市町村独自の制度まで、地域密着型の助成金も見つかります。</p>
                        </div>
                    </article>
                ...
                <div class="related-prefectures-section">
                    <h2 class="related-prefectures-title">
                    ...
                    <div class="related-prefectures-grid">
                        <?php 
                        $count = 0;
                        foreach ($related_prefectures as $rel_pref): 
                            if ($count >= 6) break;
                            $rel_term = get_term_by('slug', $rel_pref['slug'], 'grant_prefecture');
                            if (!$rel_term || is_wp_error($rel_term)) continue;
                            $count++;
                        ?>
                        <a href="<?php echo esc_url(get_term_link($rel_term)); ?>" 
                           class="related-prefecture-card"
                           title="<?php echo esc_attr($rel_pref['name']); ?>の助成金を見る">
                            <div class="card-icon">
                            ...
                            <span class="related-prefecture-name"><?php echo esc_html($rel_pref['name']); ?></span>
                            <span class="related-prefecture-count"><?php echo number_format($rel_term->count); ?>件</span>
                    ...
                    <div class="filter-dropdown-wrapper">
                        <label class="filter-label" id="municipality-label">市町村
                            <span class="selected-prefecture-name" 
                                  id="selected-prefecture-name">(<?php echo esc_html($prefecture_name); ?>)</span>
                        </label>
        ...
        <aside class="yahoo-sidebar" role="complementary" aria-label="サイドバー">
            ...
            <section class="sidebar-widget sidebar-topics">
                <h3 class="widget-title">
                    ...
                    <?php echo esc_html($prefecture_name); ?>の新着トピックス
                </h3>
                <div class="widget-content">
            ...
            <section class="sidebar-widget sidebar-related-prefectures">
                ...
                <div class="widget-content">
                    <ul class="related-prefectures-list">
                        <?php 
                        $count = 0;
                        foreach ($related_prefectures as $rel_pref): 
                            if ($count >= 6) break;
                            ...
                            $count++;
                        ?>
                        <li class="related-prefecture-item">
                            <a href="<?php echo esc_url(get_term_link($rel_term)); ?>" class="related-prefecture-link">
                                <?php echo esc_html($rel_pref['name']); ?>
                                <span class="related-prefecture-count">(<?php echo number_format($rel_term->count); ?>)</span>
                            </a>
                        </li>
                        <?php endforeach; ?>
                    </ul>
    ...
    <section class="seo-content-section">
        <div class="yahoo-container">
            <div class="seo-content-wrapper">
                <h2 class="seo-title"><?php echo esc_html($prefecture_name); ?>の助成金について</h2>
                <div class="seo-text">
                    <p>
...
<style>
/* ===================================
   Yahoo! JAPAN Inspired Prefecture Archive Design
   完全版CSS - 省略なし
   =================================== */
...
.prefecture-hero-section {
    padding: 40px 0;
    background: linear-gradient(135deg, #e3f2fd 0%, var(--yahoo-secondary) 100%);
    border-bottom: 2px solid var(--yahoo-primary);
    position: relative;
}

.prefecture-hero-section::before {
    content: '';
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
    bottom: 0;
    background: radial-gradient(circle at top right, rgba(0, 120, 255, 0.03) 0%, transparent 50%);
    pointer-events: none;
}
...
.prefecture-name-highlight {
    background: linear-gradient(180deg, transparent 60%, rgba(0, 120, 255, 0.2) 60%);
    padding: 0 4px;
...
.prefecture-lead-section {
    margin: 24px 0;
}

.prefecture-description-rich {
    margin-bottom: 20px;
    line-height: 1.8;
    color: var(--yahoo-gray-700);
    font-size: 15px;
...
.prefecture-description-rich p {
    margin: 0 0 16px 0;
}

.prefecture-description-rich p:last-child {
    margin-bottom: 0;
}
...
.prefecture-lead-sub strong {
    color: var(--yahoo-primary);
    font-weight: 700;
}

.prefecture-meta-info {
    display: flex;
    align-items: center;
    gap: 24px;
    margin: 24px 0;
...
.related-prefectures-grid {
    display: grid;
    grid-template-columns: repeat(auto-fill, minmax(180px, 1fr));
    gap: 12px;
}

.related-prefecture-card {
    position: relative;
    display: flex;
    align-items: center;
    gap: 10px;
...
.related-prefecture-card:hover {
    border-color: var(--yahoo-blue);
    transform: translateY(-2px);
    box-shadow: var(--yahoo-shadow);
}

.related-prefecture-card .card-icon {
    flex-shrink: 0;
    width: 32px;
    height: 32px;
...
.related-prefecture-name {
    flex: 1;
    font-size: 14px;
    font-weight: 600;
}

.related-prefecture-count {
    font-size: 11px;
    color: var(--yahoo-gray-500);
}

.related-prefecture-card .arrow-icon {
    position: absolute;
    right: 12px;
    top: 50%;
...
.related-prefecture-card:hover .arrow-icon {
    color: var(--yahoo-blue);
...
.widget-title {
    ...
    padding: 12px 16px;
    background: var(--yahoo-gray-50);
    border-bottom: 2px solid var(--yahoo-blue);
    font-size: 14px;
    font-weight: 700;
    color: var(--yahoo-primary);
    margin: 0;
...
/* ===== Sidebar Related Prefectures ===== */
.sidebar-related-prefectures .related-prefectures-list {
    list-style: none;
    margin: 0;
    padding: 0;
    display: flex;
...
.related-prefecture-item {
    border-bottom: 1px solid var(--yahoo-gray-200);
    padding-bottom: 8px;
}

.related-prefecture-item:last-child {
    border-bottom: none;
    padding-bottom: 0;
}

.related-prefecture-link {
    display: flex;
    justify-content: space-between;
    align-items: center;
    text-decoration: none;
...
.related-prefecture-link:hover {
    color: var(--yahoo-blue);
    text-decoration: underline;
}

.sidebar-related-prefectures .related-prefecture-count {
    font-size: 11px;
    color: var(--yahoo-gray-500);
    font-weight: 400;
}
...
(function() {
    ...
    const PREFECTURE_SLUG = '<?php echo esc_js($prefecture_slug); ?>';
    const PREFECTURE_ID = <?php echo $prefecture_id; ?>;
    ...
    function init() {
        console.log('🚀 Prefecture Archive v20.0 Initialized:', PREFECTURE_SLUG);
    ...
    function loadMunicipalities() {
        ...
        formData.append('prefecture_slug', PREFECTURE_SLUG);
    ...
    function clearSearch() {
        ...
        resetSelect(elements.municipalitySelect, 'すべて');
        resetSelect(elements.amountSelect, '指定なし');
        resetSelect(elements.statusSelect, 'すべて');
        resetSelect(elements.sortSelect, '新着順');
    ...
    function loadGrants() {
        ...
        formData.append('prefectures', JSON.stringify([PREFECTURE_SLUG]));
    ...
    console.log('✅ Prefecture Archive v20.0 - Fully Loaded');
...
// デバッグ: 広告関数の存在確認
(function() {
    console.log('\n🔍 === Ad Function Debug Info (Prefecture Archive) ===');
    console.log('📍 Page: taxonomy-grant_prefecture.php');
    ...
    echo "console.log('  - Prefecture: " . esc_js($prefecture_name) . "');";
    echo "console.log('  - Prefecture Slug: " . esc_js($prefecture_slug) . "');";
    if ($region_display_name) {
        echo "console.log('  - Region: " . esc_js($region_display_name) . "');";
    }
    ?>
    ...
    console.log('\n💡 Prefecture Archive Ad Spaces:');
    console.log('  1. prefecture_grant_sidebar_top');
    console.log('  2. prefecture_grant_sidebar_middle');
    console.log('  3. prefecture_grant_sidebar_bottom');
    console.log('🔍 ================================\n');
})();
</script>
